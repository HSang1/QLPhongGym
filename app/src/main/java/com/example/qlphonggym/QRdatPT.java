...
public class QRdatPT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.qr_datpt);

        qrCodeImage = findViewById(R.id.qr_code_image);

        // Lấy dữ liệu từ Intent
        String PTCode = getIntent().getStringExtra("PTCode");
        ...
        txtQuayLai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(QRdatPT.this, datPT.class); // Chuyển sang màn hình Trang Chủ
        ...
        if (PTCode != null && dateTime != null && location != null) {
            // Kết hợp thông tin thành một chuỗi để hiển thị trong mã QR
            String qrContent = "Ma PT: " + PTCode + "\n"
                    + "Dia diem: " + location + "\n"
                    + "Thoi gian: " + dateTime + "\n";
